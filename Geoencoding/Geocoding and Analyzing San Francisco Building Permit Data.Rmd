---
title: Geocoding and Analyzing San Francisco Building Permit Data
subtitle: "OpenStreetMap + R + Tableau"
author: "Anurag Malipeddi"
date: "March 2021"
output: 
...
```{r}
write_csv(bldg_df, "data/building_georecord.csv")
```
